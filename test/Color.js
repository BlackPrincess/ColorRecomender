TestCase("Test Color",{
    ...
    "test Color.additiveBlend" : function(){
        ...
        var actual = target.additiveBlend(addition);
    ...
    "test Color.addHue" : function() {
        var base = princessJs.Color.createFromHSV(100, 50, 50);
        var excepted = princessJs.Color.createFromHSV(150, 50, 50);
        assertEquals(excepted.toHSV(), base.addHue(50).toHSV());
    },

    "test Color.addSaturation" : function() {
        var base = princessJs.Color.createFromHSV(100, 50, 50);
        var excepted = princessJs.Color.createFromHSV(100, 100, 50);
        assertEquals(excepted.toHSV(), base.addSaturation(50).toHSV());
    },
    "test Color.addLightness" : function() {
        var base = princessJs.Color.createFromHSV(100, 50, 50);
        var excepted = princessJs.Color.createFromHSV(100, 50, 100);
        assertEquals(excepted.toHSV(), base.addLightness(50).toHSV());
    },
